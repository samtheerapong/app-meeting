        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return Html::img('uploads/person/'.$model->photo,['class' => 'thumbnail', 'width'=> '50px']); 
                },
            ],
            'user.username',
            //'user.password_hash',
            ...
            [
                ...
                'filter' => Html::activeDropDownList($searchModel, 'department_id', ArrayHelper::map(Department::find()->all(), 'id', 'department'), ['class' => 'form-control', 'prompt' => 'ทั้งหมด...'])
            ],
